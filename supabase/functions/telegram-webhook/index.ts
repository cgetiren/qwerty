...
const DIL_BRAND_ID = "00000000-0000-0000-0000-000000000003";
...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    if (!settings.telegram_chat_id) {
      ...
      console.log("Auto-configured Dil telegram_chat_id: " + incomingChatId);
    }
    ...
    console.log("Dil webhook received:", JSON.stringify({ rawText, cleanedWithoutSlash, chatType: message.chat.type }));
    ...
    if (egitimCmdMatch) {
      ...
      if (!chatInfo || chatInfo.brand_id !== DIL_BRAND_ID) {
        await sendTelegramMessage(
          settings.telegram_bot_token,
          incomingChatId,
